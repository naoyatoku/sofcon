...
wsl -e bash -c "cd /mnt/c/Users/toku/private/sofcon/cpp && g++ -O2 -std=c++14 -pthread -DMCTS_SELFTEST mcts_player.cpp -o mcts_test 2>&1"
...
wsl -e bash -c "cd /mnt/c/Users/toku/private/sofcon/cpp && g++ -O2 -std=c++14 bench.cpp -o bench 2>&1"
if errorlevel 1 ( echo BUILD FAILED & pause & exit /b 1 )
